...
> **갱신 (2026-07-07)**: #117의 multi-page 온보딩 마법사(4번째 플러그인 `claude-kit-welcome`)는 만들어지지 않고 backlog로 닫혔어요. 실제 shipped된 건 훨씬 작은 `thinking-tools/hooks/session-start-welcome.sh`(1회성 discoverability 힌트)뿐이에요. 이 카탈로그 자체(4-흐름 매핑)는 그와 독립적으로 유효해요.
