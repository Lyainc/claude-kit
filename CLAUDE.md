...
- **thinking-tools** (`thinking-tools/`): 사고 도구 스킬 8개 + 에이전트 1개 (diverse-sampling, doc-concretize, doc-polish, expert-panel, unknown-discovery, thought-chain, adversarial-review, build-spec + thinking-facilitator agent)
...
│   ├── commands/                        # 4개 슬래시 커맨드 정의 (/handoff은 G26 retire)
