...
| **②결정화·출력** | 포맷·목적별 산출물 | spec-first(seed) · doc-concretize · doc-polish · graphify(html) · note · issue | claude-kit (leaf) |
