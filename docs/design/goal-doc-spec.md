...
| **#133** (슬라이스 스킬 귀속) | §3.2 `candidate-or` 문법(`placeholder` `<#133>`는 후보 미정 시의 별개 토큰) + §3.6 native 위임 우선 표기 | ✅ 미확정 귀속을 `candidate-or`(`executor\|native(#133)`)로, #133이 확정 |
